...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "changerace",     SEC_GAMEMASTER,              false,  &HandleUtilityChangeRaceCommand,    "", NULL },
            { "changefaction",  SEC_GAMEMASTER,              false,  &HandleUtilityChangeFactionCommand, "", NULL },
            { "customize",      SEC_GAMEMASTER,              false,  &HandleUtilityCustomizeCommand,     "", NULL },
        ...
        static ChatCommand commandTable[] =
        {
            ...
            { "utility",            SEC_GAMEMASTER,          false, NULL,                                "", utilityCommandTable },
            { NULL,                 0,                      false, NULL,                                "", NULL }
        };
        return commandTable;
    }
