    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand debugCommandTable[] =
        {
           ...
           /* { "moveflags",      SEC_ADMINISTRATOR,  false, &HandleDebugMoveflagsCommand,       "", NULL }, */
            { "phase",          SEC_GAMEMASTER,      false, &HandleDebugPhaseCommand,           "", NULL },
            { "unroot",         SEC_GAMEMASTER,      false, &HandleDebugUnRootCommand,          "", NULL },
            { "combat",         SEC_GAMEMASTER,      false, &HandleDebugCombatCommand,          "", NULL },
            { NULL,             SEC_PLAYER,         false, NULL,                               "", NULL }
        };
